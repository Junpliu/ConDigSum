...
def save_checkpoint(cfg: CheckpointConfig, trainer, epoch_itr, val_loss, save_epoch):
    ...
    ) or (str(epoch) in save_epoch.split(','))
...
def load_checkpoint(cfg: CheckpointConfig, trainer, **passthrough_args):
    ...
    *passthrough_args* will be passed through to
    ...
    if (
        ...
        print('debug, enter this condition always! ')
    ...
    if False and extra_state is not None and not reset_dataloader:
        assert False, 'debug, disable restoring iterator from checkpoint'
        ...
        logger.info('disable restoring iterator from checkpoint, always train from the beginning. ')
        epoch_itr = trainer.get_train_iterator(
...
def load_checkpoint_to_cpu(path, arg_overrides=None, load_on_all_ranks=False):
    ...
    print('best_epoch {}'.format(state['extra_state']['train_iterator']['epoch']))
