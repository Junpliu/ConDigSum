...
class FairseqAdam(FairseqOptimizer):
    ...
    def __init__(self, cfg: DictConfig, params, class_lr=None):
        self.class_lr = class_lr
        print('class_lr', class_lr)
        super().__init__(cfg)
    ...
    def set_lr(self, lr):
        ...
        for idx, param_group in enumerate(self.param_groups):
            if self.class_lr is not None:
                if idx == len(self.param_groups) - 1:
                    param_group["lr"] = lr * self.class_lr
                else:
                    param_group["lr"] = lr
            else:
                param_group["lr"] = lr
