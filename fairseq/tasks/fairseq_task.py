...
class FairseqTask(object):
    ...
    def get_batch_iterator(
        ...
        # logger.info('dataset.__class__.__name__ {}'.format(dataset.__class__.__name__ ))
    ...
    def train_step(
        self, sample, model, criterion, optimizer, update_num, ignore_grad=False, training_type=None, debug_forward=False, co_T=None, ma_T=None, loss_weight=None, new_loss_cal=None, noaux=None, margin_delta_co=1, margin_delta_su=1
    ):
        """
        ...
        if debug_forward:
            with torch.no_grad():
                loss, sample_size, logging_output, other_log = criterion(model, sample, training_type=training_type, co_T=co_T, ma_T=ma_T, loss_weight=loss_weight, new_loss_cal=new_loss_cal, margin_delta_co=margin_delta_co, margin_delta_su=margin_delta_su)
        else:
        ...
        return loss, sample_size, logging_output, other_log
